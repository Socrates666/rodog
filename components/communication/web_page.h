        ...
        <section id="buttons">
            <div id="controls" class="control-container">
                <table>
                    ...
                    <tr>
                        <td align="center"><button class="button button4" onclick="fetch(document.location.origin+'/control?var=sload&val=0&cmd=0').then(() => refreshCalibration());">Load NVS</button></td>
                        <td align="center"><button class="button button4" onclick="fetch(document.location.origin+'/control?var=sreset&val=0&cmd=0').then(() => refreshCalibration());">Reset Cal</button></td>
                        <td align="center"><button class="button button4" onclick="refreshCalibration();">Refresh</button></td>
                    </tr>
                    <tr>
                        <td colspan="3" align="center"><pre id="calib-view" style="text-align:left; margin-top:8px;">Cal data: (fetching...)</pre></td>
                    </tr>


                    <tr>
                        <td align="center"><input id="pwm0" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(0);">Set PWM0</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=0&cmd=1');">0_SET</button></td>
                    </tr>
                    <tr>
                        <td align="center"><input id="pwm1" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(1);">Set PWM1</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=1&cmd=1');">1_SET</button></td>
                    </tr>
                    <tr>
                        <td align="center"><input id="pwm2" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(2);">Set PWM2</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=2&cmd=1');">2_SET</button></td>
                    </tr>
                    <tr>
                        <td align="center"><input id="pwm3" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(3);">Set PWM3</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=3&cmd=1');">3_SET</button></td>
                    </tr>


                    <tr>
                        <td align="center"><input id="pwm4" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(4);">Set PWM4</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=4&cmd=1');">4_SET</button></td>
                    </tr>
                    <tr>
                        <td align="center"><input id="pwm5" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(5);">Set PWM5</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=5&cmd=1');">5_SET</button></td>
                    </tr>
                    <tr>
                        <td align="center"><input id="pwm6" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(6);">Set PWM6</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=6&cmd=1');">6_SET</button></td>
                    </tr>
                    <tr>
                        <td align="center"><input id="pwm7" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(7);">Set PWM7</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=7&cmd=1');">7_SET</button></td>
                    </tr>


                    <tr>
                        <td align="center"><input id="pwm8" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(8);">Set PWM8</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=8&cmd=1');">8_SET</button></td>
                    </tr>
                    <tr>
                        <td align="center"><input id="pwm9" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(9);">Set PWM9</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=9&cmd=1');">9_SET</button></td>
                    </tr>
                    <tr>
                        <td align="center"><input id="pwm10" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(10);">Set PWM10</button></td>
                    ...
                    <tr>
                        <td align="center"><input id="pwm11" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(11);">Set PWM11</button></td>
                    ...
                    <tr>
                        <td align="center"><input id="pwm12" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(12);">Set PWM12</button></td>
                    ...
                    <tr>
                        <td align="center"><input id="pwm13" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(13);">Set PWM13</button></td>
                    ...
                    <tr>
                        <td align="center"><input id="pwm14" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(14);">Set PWM14</button></td>
                    ...
                    <tr>
                        <td align="center"><input id="pwm15" type="number" style="width:60px;"></td>
                        <td align="center"><button class="button" onclick="setPWM(15);">Set PWM15</button></td>
